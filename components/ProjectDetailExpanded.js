...
function ProjectCard({ project, index, isExpanded, onToggle }) {
  ...
  return (
    <motion.div
      className="mb-6 bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-lg"
    ...
    >
      ...
      <motion.div
        className={`relative cursor-pointer bg-gradient-to-br ${gradient} p-8`}
        onClick={onToggle}
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm mt-1">{project.description}</p>
              </div>
            </div>
          ...
          >
            <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/50 flex items-center justify-center">
                ...
                >
                  {activeTab === 'overview' && (
                    <div className="space-y-6">
                      {/* All Tech Stack */}
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 mb-4">Complete Tech Stack</h3>
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          {project.highlights.map((highlight, i) => (
                            <motion.div
                              ...
                              whileHover={{ scale: 1.02, borderColor: '#0071e3' }}
                            >
                  ...
                  {activeTab === 'business' && project.businessContext && (
                    <div className="prose prose-lg max-w-none">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Business Context & Objectives</h3>
                  ...
                  {activeTab === 'solution' && project.solutionOverview && (
                    <div className="prose prose-lg max-w-none">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Solution Overview</h3>
                      <div className="text-gray-700 leading-relaxed space-y-4">
                  ...
                  {activeTab === 'technical' && project.technicalArchitecture && (
                    <div className="prose prose-lg max-w-none">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Technical Architecture & Implementation</h3>
                      <div className="text-gray-700 leading-relaxed space-y-4">
                  ...
                  {activeTab === 'impact' && project.impact && (
                    <div className="prose prose-lg max-w-none">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Impact & Outcomes</h3>
                      <div className="text-gray-700 leading-relaxed space-y-4">
                      ...
                      {project.whyItMatters && (
                        ...
                        >
                          <h4 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            <span>💡</span> Why This Project Matters
                          </h4>
...
export default function ProjectDetailExpanded({ projects }) {
